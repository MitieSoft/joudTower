        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 relative z-10">
          <div className="flex justify-center">
            <div className="text-white text-center max-w-4xl w-full">
              <h1 className={`text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl ${isRTL ? 'font-extrabold' : 'font-medium'}  leading-tight px-4 sm:px-0 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ fontFamily: 'Univers, Arial, sans-serif' }}>
                {t.hero.title}
              </h1>
